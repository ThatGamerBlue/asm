 ...
 * @property localStackIds IntArray
 * @constructor
 */
data class ExecState(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (!localStackIds.contentEquals(other.localStackIds)) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + localStackIds.contentHashCode()
        return result
    }
